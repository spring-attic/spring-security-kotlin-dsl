...
package org.springframework.security.dsl.config.builders.server.oauth2.resourceserver
 ...
 */
internal class ServerOpaqueTokenDslTests {
    @Rule
    @JvmField
    ...
    @EnableWebFluxSecurity
    @EnableWebFlux
    class CustomIntrospectorConfig {
        companion object {
            var MOCK_WEB_SERVER: MockWebServer = MockWebServer()
        }
    ...
    @EnableWebFluxSecurity
    @EnableWebFlux
    class CustomIntrospectionUriAndCredentialsConfig {
        companion object {
            var MOCK_WEB_SERVER: MockWebServer = MockWebServer()
        }
