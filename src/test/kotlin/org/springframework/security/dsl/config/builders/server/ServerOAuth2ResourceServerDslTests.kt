 ...
 */
internal class ServerOAuth2ResourceServerDslTests {
    ...
    @EnableWebFluxSecurity
    @EnableWebFlux
    class BearerTokenConverterConfig {
        companion object {
    ...
    @EnableWebFluxSecurity
    @EnableWebFlux
    class AuthenticationManagerResolverConfig {
        companion object {
